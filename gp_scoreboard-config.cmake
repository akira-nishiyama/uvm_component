...
#  gp_scoreboard_INCLUDE_DIRS      - include directories for gp_scoreboard package.(empty)
...
#  gp_scoreboard_DEFINITIONS_VLOG  - additional compile option for vlog.(empty)
#  gp_scoreboard_DEPENDENCIES      - gp_scoreboard components list. use for target depends.(no dependencies)

# Compute paths
set(gp_scoreboard_INCLUDE_DIRS "")
...
set(gp_scoreboard_DEFINITIONS_VLOG "")
